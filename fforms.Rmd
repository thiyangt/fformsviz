...
py <- ggplot(yearly_m4_clus, 
 ...
 scale_fill_manual(values=rev(c("#1b9e77","#d95f02",
  ...
  theme(axis.text.x = element_text(angle = 90)) + xlab("True class label (Best forecast model)") + ylab("Count")+ 
...
pq <- ggplot(quarterly_m4_clus, 
 ...
 scale_fill_manual(values=rev(c("#1b9e77","#d95f02",
                       "#7570b3", "#e7298a", "#66a61e"))) + 
  theme(axis.text.x = element_text(angle = 90)) + xlab("Class label (Best forecast model)") +  ylab("Count")+
  ggtitle("Quarterly Series Composition of clusters by class labels (best forecast model)")
...
pm <- ggplot(monthly_m4_clus, 
 ...
 scale_fill_manual(values=rev(c("#1b9e77","#d95f02",
                       "#7570b3", "#e7298a", "#66a61e"))) + 
  theme(axis.text.x = element_text(angle = 90)) + xlab("Class label (Best forecast model)") +  ylab("Count")+
  ggtitle("Monthly Series Composition of clusters by class labels (best forecast model)")
...
pw <- ggplot(weekly_m4_clus, 
 ...
 scale_fill_manual(values=rev(c("#1b9e77","#d95f02",
                       "#7570b3", "#e7298a", "#66a61e"))) + 
  theme(axis.text.x = element_text(angle = 90)) + xlab("True class label (the best forecast model)") +  ylab("Count")+
  ggtitle("Weekly series composition of clusters by true class labels (the best forecast model)")
...
daily_m4_clus$trueLabel <- factor(dm4_true_classlabels,
                                      levels=c("rwd", "stlar", "mstlarima", "mstlets","rw", "snaive",
                                        "tbats", "wn", "nn", "theta"))
...
hp <- ggplot(hourly_m4_clus, 
 ...
 scale_fill_manual(values=rev(c("#1b9e77","#d95f02",
                       "#7570b3", "#e7298a", "#66a61e"))) + 
  theme(axis.text.x = element_text(angle = 90)) + xlab("Class label") +  ylab("Count")+
  ggtitle("Monthly Series Composition of clusters by class labels")
